...
import locale from 'element-ccc/lib/locale/lang/en'
...
import lang from 'element-ccc/lib/locale/lang/en'
import locale from 'element-ccc/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/element-ccc[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'element-ccc/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'element-ccc/lib/locale/lang/en'
import zhLocale from 'element-ccc/lib/locale/lang/zh-CN'
...
import enLocale from 'element-ccc/lib/locale/lang/en'
import zhLocale from 'element-ccc/lib/locale/lang/zh-CN'
import ElementLocale from 'element-ccc/lib/locale'
...
<script src="//unpkg.com/element-ccc"></script>
<script src="//unpkg.com/element-ccc/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/element-ccc"></script>
<script src="//unpkg.com/element-ccc/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/element-ccc/lib/umd/locale/en.js"></script>
